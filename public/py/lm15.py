...
def process_images(image_folder, output_folder, fps=60):
    ...
    for i in range(0, len(images) - 2, 4):  # 跳过3张
        ...
        adjust_image_alpha(image_a_png_path, 0.75, blended_image_a)
        adjust_image_alpha(image_b_png_path, 0.25, blended_image_b)
        ...
        frame_counter += 1
        # 第3帧，图片a透明度为0.5，图片b透明度为0.5
        adjust_image_alpha(image_a_png_path, 0.5, blended_image_a)
        adjust_image_alpha(image_b_png_path, 0.5, blended_image_b)
        ...
        frame_counter += 1
        # 第4帧，图片a透明度为0.5，图片b透明度为0.5
        adjust_image_alpha(image_a_png_path, 0.25, blended_image_a)
        adjust_image_alpha(image_b_png_path, 0.75, blended_image_b)
...
if __name__ == "__main__":
    ...
    output_folder = "../ProcessedImages/lm15"  # 输出图片文件夹路径
    fps = 60  # 每秒帧数
